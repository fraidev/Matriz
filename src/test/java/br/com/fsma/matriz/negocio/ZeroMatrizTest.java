...
class ZeroMatrizTest {
	...
	void deveRetornarOsValoresDosElementosDaMatrizInversa() {
		...
		assertEquals(Double.NaN, novaMatriz.getValor(0,0) );
		assertEquals(Double.NaN, novaMatriz.getValor(0,1) );
		assertEquals(Double.NaN, novaMatriz.getValor(0,2) );
		assertEquals(Double.NaN, novaMatriz.getValor(1,0) );
		assertEquals(Double.NaN, novaMatriz.getValor(1,1) );
		assertEquals(Double.NaN, novaMatriz.getValor(1,2) );
		assertEquals(Double.NaN, novaMatriz.getValor(2,0) );
		assertEquals(Double.NaN, novaMatriz.getValor(2,1) );
		assertEquals(Double.NaN, novaMatriz.getValor(2,2) );
	}
	...
	void deveRetornarOsValoresDosElementosDaMatrizTransposta() {
		...
		assertEquals(0.0f, novaMatriz.getValor(0,0) );
		...
		assertEquals(0.0f, novaMatriz.getValor(1,1) );
		...
		assertEquals(0.0f, novaMatriz.getValor(2,2) );
	}

	@Test
	void deveRetornarVerdadeiroSeAsMatrizesForemIguais() {
		Matriz3x3 matriz = new ZeroMatriz();
		Matriz3x3 matriz2 = new ZeroMatriz();
